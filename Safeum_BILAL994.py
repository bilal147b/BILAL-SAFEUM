...
to(
    f"\033[31;m Script Type>> \033[1;36mSafeUm Account Maker \n\033[1;31m Telegram >>\033[1;33m@bilatermuteam1\n\033[31;m Creator >>\033[1;33m@BILAL BALOCH\n\033[31;m Tool Status >>\033[1;33mWorking\n\033[31;m Tool Value >>\033[1;33mFree\n\033[31;m Time >>\033[1;33m24 Hours\n\033[31;m")
print('')
print('\033[32;m')
webbrowser.open("https://chat.whatsapp.com/BsOxo1XxmiPJJg2DkXR0Kt?mode=hqrt3")
...
def work():
    ...
    try:
        ...
        if '"status":"Success"' in gzip:
            ...
            print(b)
            with open('safeum-BILAL-Accounts.txt', 'a') as f:
                f.write(username + ":mmmm | AM : @bilatermuteam1\n")
